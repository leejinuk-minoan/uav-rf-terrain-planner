...
| BUILD-20260720-011 | 2026-07-20 | 036B | Implement immutable prepared-evidence contracts and a pure minimum-altitude proxy engine. | Issue #110; Draft PR #111. | Base `f3a0758`; local amendment head pending one local fix commit. | Synthetic prepared profiles only. | Focused 70; related Task 035EF/035G plus legacy 58; full 983 passed, 1 skipped. | Fresh local verification passed; exact final-head CI remains pending for the Draft PR completion comment. | Local amendment verified; publish/review pending. | EXP-058; DEC-009; Task 036B handoff. | No terrain session, GIS sampling, route selection, UI, device, or field claim. |
